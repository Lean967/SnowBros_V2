...
public class FabricaEntidades {
    ...
    public RanaDeFuego getRanaDeFuego(Posicion pos){
        RanaDeFuego rana= new RanaDeFuego(sprites.getSpritesRanaDeFuego(), pos);
        return rana;
    }
    ...
    public BolaDeFuego getBolaDeFuego(Posicion pos){
        BolaDeFuego bola= new BolaDeFuego(sprites.getSpritesBolaDeFuego(),pos);
        return bola;
    }
    public Bomba getBomba(Posicion pos){
        Bomba bomba= new Bomba(sprites.getSpritesBomba(),pos);
        return bomba;
    }

    public TrollAmarillo getTrollAmarillo(Posicion pos){
        TrollAmarillo troll = new TrollAmarillo(sprites.getSpritesTrollAmarillo(), pos);
        return troll;
    }

    public Calabaza getCalabaza(Posicion pos){
        Calabaza calabaza = new Calabaza(sprites.getSpritesCalabaza(), pos);
        return calabaza;
    }
    ...
    public Kamakichi getKamakichi(Posicion posicion) {
        Kamakichi kamakichi= new Kamakichi(sprites.getSpritesKamakichi(), posicion);
        return kamakichi;
    }

    public Moghera getMoghera(Posicion posicion) {
        Moghera moghera= new Moghera(sprites.getSpritesMoghera(),posicion);
        return moghera;
    }

    public Fantasma getFantasma(Posicion pos){
        Fantasma fantasma= new Fantasma(sprites.getSpritesFantasma(),pos);
        return fantasma;
    }
}
