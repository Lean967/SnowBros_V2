...
public class SueloResbaladizo extends Obstaculo {
    ...
    public void hacerEfecto(SnowBro snowbro) {
        ...
        snowbro.setVelocidadDefectoX(ConstantesTeclado.VELOCIDAD_SNOWBRO_X / 2);
    }
    ...
    protected SueloResbaladizo crearObstaculo(){
        SueloResbaladizo nuevoSuelo = new SueloResbaladizo(misSprites, posicion);
        nuevoSuelo.setDimensiones(ancho, alto);
        return nuevoSuelo;
    }
}
